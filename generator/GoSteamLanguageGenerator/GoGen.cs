...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"google.golang.org/protobuf/proto/proto\"");
            sb.AppendLine("    \"github.com/dotabook/go-steam/steamid\"");
            sb.AppendLine("    \"github.com/dotabook/go-steam/rwu\"");
            sb.AppendLine("    \"github.com/dotabook/go-steam/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
